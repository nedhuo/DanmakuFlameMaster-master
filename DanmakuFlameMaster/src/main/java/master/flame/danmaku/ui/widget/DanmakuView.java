...
public class DanmakuView extends View implements IDanmakuView, IDanmakuViewController {
    ...
    private OnDanmakuClickListener mOnDanmakuClickListener;//点击事件监听
    ...
    private DanmakuTouchHelper mTouchHelper; //触摸事件处理类
    ...
    private void init() {
        ...
        DrawHelper.useDrawColorToClearCanvas(true, false);//todo
